...
$SCRIPT_HOME/poetry.sh -C $SCRIPT_HOME run pyinstaller -n cpm -y --add-data=./cpm_version:. --workpath $PYINSTALLER_WORKPATH --distpath $PYINSTALLER_DIST $SCRIPT_HOME/cpm/__main__.py
